...
description: Refactor framework-independent or unusual test grouping into explicit manual registration.
keywords: [manual-registration, suite, organization]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor framework-independent or unusual test grouping into explicit manual registration.
...
## When to use
Use when the test problem is well described by: framework-independent or unusual test grouping into explicit manual registration
...
## Prefer over
[Test Discovery](./048-test-discovery.md)
...
## Notes
See also [Test Discovery](./048-test-discovery.md).
