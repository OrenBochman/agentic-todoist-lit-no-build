---
title: Layer Test
description: Refactor blurry cross-layer tests into tests that target one architectural layer at a time.
keywords: [architecture, frontend, backend, service, integration]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor blurry cross-layer tests into tests that target one architectural layer at a time.
...
## When to use
Use when the test problem is well described by: blurry cross-layer tests into tests that target one architectural layer at a time
...
## Prefer over
[Humble Object](./025-humble-object.md)
...
## Notes
See also [Humble Object](./025-humble-object.md).
