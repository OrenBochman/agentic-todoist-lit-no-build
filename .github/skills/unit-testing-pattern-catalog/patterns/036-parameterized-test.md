...
description: Refactor a small local family of similar cases into one test plus parameters.
keywords: [cases, examples, regression, unit]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor a small local family of similar cases into one test plus parameters.
...
## When to use
Use when several examples share one full test lifecycle and differ only by small local inputs and expectations.
...
## Prefer over
[Data-Driven Test](./010-data-driven-test.md)
...
## Notes
See also [Data-Driven Test](./010-data-driven-test.md).
