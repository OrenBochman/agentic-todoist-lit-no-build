---
title: Literal Value
description: Refactor unnecessary calculated or generated test data back into explicit constants.
keywords: [constant, readability, fixture, unit]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor unnecessary calculated or generated test data back into explicit constants.
...
## When to use
Use when the test problem is well described by: unnecessary calculated or generated test data back into explicit constants
...
## Prefer over
[Derived Value](./016-derived-value.md)
...
## Notes
See also [Derived Value](./016-derived-value.md).
