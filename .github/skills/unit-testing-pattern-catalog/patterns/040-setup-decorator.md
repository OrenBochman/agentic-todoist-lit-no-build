---
title: Setup Decorator
description: Refactor suite-wide setup and teardown into a wrapper around the whole suite.
keywords: [suite, shared-resource, lifecycle, organization]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor suite-wide setup and teardown into a wrapper around the whole suite.
...
## When to use
Use when the test problem is well described by: suite-wide setup and teardown into a wrapper around the whole suite
...
## Prefer over
[Suite Fixture Setup](./045-suite-fixture-setup.md)
...
## Notes
See also [Suite Fixture Setup](./045-suite-fixture-setup.md).
