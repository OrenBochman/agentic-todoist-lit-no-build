...
description: Refactor mixed test bodies into linear setup, exercise, verification, and teardown phases.
keywords: [structure, setup, verify, teardown, readability, unit]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor mixed test bodies into linear setup, exercise, verification, and teardown phases.
...
## When to use
Use when the test problem is well described by: mixed test bodies into linear setup, exercise, verification, and teardown phases
...
## Prefer over
[In-line Setup](./028-in-line-setup.md)
...
## Notes
See also [In-line Setup](./028-in-line-setup.md).
