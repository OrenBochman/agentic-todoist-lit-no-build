---
title: Testcase Class per Feature
description: Refactor test organization by grouping tests around one behavior or feature instead of one class name.
keywords: [feature, behavior, organization, unit]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor test organization by grouping tests around one behavior or feature instead of one class name.
...
## When to use
Use when the test problem is well described by: test organization by grouping tests around one behavior or feature instead of one class name
...
## Prefer over
[Testcase Class per Class](./062-testcase-class-per-class.md)
...
## Notes
See also [Testcase Class per Class](./062-testcase-class-per-class.md).
