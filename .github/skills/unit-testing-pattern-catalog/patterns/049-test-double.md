---
title: Test Double
description: Refactor use of real collaborators by choosing the narrowest suitable test-specific replacement.
keywords: [double, mock, stub, spy, fake, dummy, isolation]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor use of real collaborators by choosing the narrowest suitable test-specific replacement.
...
## When to use
Use when the test problem is well described by: use of real collaborators by choosing the narrowest suitable test-specific replacement
...
## Notes
See also [Dummy Object](./017-dummy-object.md).
