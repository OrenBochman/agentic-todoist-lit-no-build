...
description: Refactor repeated common setup into a shared setup hook.
keywords: [setup-hook, fixture, repeated-setup, unit]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor repeated common setup into a shared setup hook.
...
## When to use
Use when the test problem is well described by: repeated common setup into a shared setup hook
