---
title: Delegated Setup
description: Refactor repeated inline setup into local tests plus small fixture helpers.
keywords: [fixture, setup, helper, local, fresh, unit]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor repeated inline setup into local tests plus small fixture helpers.
...
## When to use
Use when several tests still need their own fresh fixtures but repeat the same small setup fragments.
