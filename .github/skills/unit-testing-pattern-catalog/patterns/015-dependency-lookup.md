...
description: Refactor lookup-based code by exposing and stabilizing hidden collaborator access, then move toward injection.
keywords: [service-locator, hidden-dependency, container, refactor, unit]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor lookup-based code by exposing and stabilizing hidden collaborator access, then move toward injection.
...
## When to use
Use when the test problem is well described by: lookup-based code by exposing and stabilizing hidden collaborator access, then move toward injection
...
## Prefer over
[Dependency Injection](./014-dependency-injection.md)
...
## Notes
See also [Dependency Injection](./014-dependency-injection.md).
