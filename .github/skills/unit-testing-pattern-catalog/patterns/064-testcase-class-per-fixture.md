---
title: Testcase Class per Fixture
description: Refactor organization around a strong shared fixture when that is the main commonality.
keywords: [fixture, setup, organization, unit]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor organization around a strong shared fixture when that is the main commonality.
...
## When to use
Use when the test problem is well described by: organization around a strong shared fixture when that is the main commonality
