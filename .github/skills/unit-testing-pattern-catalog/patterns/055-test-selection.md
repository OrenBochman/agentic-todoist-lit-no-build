...
description: Refactor all-or-nothing test runs by tagging and filtering meaningful subsets.
keywords: [tag, smoke, slow, database, browser, ci]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor all-or-nothing test runs by tagging and filtering meaningful subsets.
...
## When to use
Use when the test problem is well described by: all-or-nothing test runs by tagging and filtering meaningful subsets
