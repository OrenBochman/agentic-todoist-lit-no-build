---
title: Test Hook
description: Refactor blocked test scenarios by adding one narrow seam for observation or control.
keywords: [hook, seam, observability, testability, ui]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor blocked test scenarios by adding one narrow seam for observation or control.
...
## When to use
Use when the test problem is well described by: blocked test scenarios by adding one narrow seam for observation or control
