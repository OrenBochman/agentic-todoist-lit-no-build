...
description: Refactor manual test registration by letting the framework find tests automatically.
keywords: [auto-discovery, runner, organization]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor manual test registration by letting the framework find tests automatically.
...
## When to use
Use when the test problem is well described by: manual test registration by letting the framework find tests automatically
...
## Prefer over
[Test Enumeration](./050-test-enumeration.md)
...
## Notes
See also [Test Enumeration](./050-test-enumeration.md).
