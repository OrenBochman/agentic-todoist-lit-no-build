---
title: Prebuilt Fixture
description: Refactor expensive stable fixture construction so it happens before test execution and is reused safely.
keywords: [expensive-setup, shared, performance, unit]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor expensive stable fixture construction so it happens before test execution and is reused safely.
...
## When to use
Use when the test problem is well described by: expensive stable fixture construction so it happens before test execution and is reused safely
...
## Notes
See also [Shared Fixture](./041-shared-fixture.md).
