---
title: Testcase Superclass
description: Refactor shared cross-class test support into one shallow abstract superclass.
keywords: [inheritance, shared-support, reuse, organization]
---

## Action List
1. Identify the current test or fixture problem that matches this pattern.
2. Apply a small refactoring to refactor shared cross-class test support into one shallow abstract superclass.
...
## When to use
Use when the test problem is well described by: shared cross-class test support into one shallow abstract superclass
